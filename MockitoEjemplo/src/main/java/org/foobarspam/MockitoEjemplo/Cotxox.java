...
public class Cotxox {
	...
	public static void main(String[] args) {
		...
		System.out.println("Driver: " + carrera.getNombreConductor());
		System.out.println("Type: " + carrera.getModeloConductor());
		System.out.println("Matricula: " + carrera.getMatriculaConductor());
		System.out.println("Stars: " + carrera.getValoracionConductor());
		System.out.println("From: " + carrera.getOrigen());
		System.out.println("To: " + carrera.getDestino());
