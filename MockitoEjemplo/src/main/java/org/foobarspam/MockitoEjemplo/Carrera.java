...
import org.foobarspam.MockitoEjemplo.TarifaAntigua;
...
public class Carrera {
	...
	public double getCosteEsperado(){
		return TarifaAntigua.getCosteTotalEsperado(this);
	}
	...
	public String getMatriculaConductor() {
		return this.conductor.getMatricula();
	}


	public double getValoracionConductor() {
		return this.conductor.getValoracion();
	}
	
	// las clases estaticas no pueden mockearse en Mockito
	public double getCosteEsperado(Tarifable tarifa){
