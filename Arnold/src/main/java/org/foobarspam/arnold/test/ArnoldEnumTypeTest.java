package org.foobarspam.arnold.test;
...
import org.foobarspam.arnold.logica.Planeta;
...
public class ArnoldEnumTypeTest {
	...
	public void PlanetaGetMasaTest(){		
		double masa1 = 3.303e+23;
		Planeta planeta = Planeta.MERCURY;

		assertThat(planeta.getMasa()).isEqualTo(masa1);
	...
	public void ArrayPlanetasTerrestresTest(){
		...
		for(int i=Planeta.MERCURY.ordinal(); i<=Planeta.MARS.ordinal(); i++){
